...
public class MoneyMarketSummaryReportIT {
    ...
    private static final LocalDate DEFAULT_MONTH_OF_STUDY = LocalDate.of(2018, 9, 1);
    private static final LocalDate UPDATED_MONTH_OF_STUDY = LocalDate.of(2018, 9, 1);
    private static final LocalDate SMALLER_MONTH_OF_STUDY = LocalDate.of(2018, 9, 1);
    ...
    @Autowired
    private Report<List<MoneyMarketSummary>, MoneyMarketSummaryParameters> moneyMarketSummaryReportService;
    ...
    public void sessionFactoryIsInjected() {
        ...
        assertThat(moneyMarketSummaryReportService).isNotNull();
    }
    ...
    public void createReport() throws Exception {
        ...
        List<MoneyMarketSummary> summaryList = moneyMarketSummaryReportService.createReport(new MoneyMarketSummaryParameters(LocalDate.of(2018, 9, 1)));
