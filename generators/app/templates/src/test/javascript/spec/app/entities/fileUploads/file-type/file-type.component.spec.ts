...
import { PrepsGateTestModule } from '../../../../test.module';
import { FileTypeComponent } from 'app/entities/fileUploads/file-type/file-type.component';
import { FileTypeService } from 'app/entities/fileUploads/file-type/file-type.service';
import { FileType } from 'app/shared/model/fileUploads/file-type.model';
...
describe('Component Tests', () => {
  describe('FileType Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fileTypes && comp.fileTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
