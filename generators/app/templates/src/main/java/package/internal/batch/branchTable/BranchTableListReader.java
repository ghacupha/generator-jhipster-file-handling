...
@Slf4j
public class BranchTableListReader implements ItemReader<List<BranchTableEVM>> {
    ...
    private ListPartition<BranchTableEVM> listPartition;

    BranchTableListReader(final ExcelFileDeserializer<BranchTableEVM> deserializer, FileUploadService fileUploadService, @Value("#{jobParameters['fileId']}") long fileId,
    ...
    private void resetIndex() {
        ...
        final List<BranchTableEVM> unProcessedItems =
     ...
     */
    @Override
    public List<BranchTableEVM> read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {

        List<BranchTableEVM> forProcessing = listPartition.getPartition();
